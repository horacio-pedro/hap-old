...
export const environment: Environment = {
  ...
  COMPANY_NAME: 'HAP, Lda',
  COMPANY_SITE: 'HAP',
  COMPANY_LINK: 'https://hap.ao/',
  COMPANY_SITE_LINK: 'https://hap.co',
  COMPANY_GITHUB_LINK: 'https://github.com/horacio-pedro',
  COMPANY_FACEBOOK_LINK: 'https://www.facebook.com/happlatform',
  COMPANY_TWITTER_LINK: 'https://twitter.com/happlatform',
  COMPANY_LINKEDIN_LINK: 'https://www.linkedin.com/company/hap.',
